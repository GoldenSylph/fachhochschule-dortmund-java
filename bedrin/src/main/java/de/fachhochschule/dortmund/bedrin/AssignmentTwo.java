...
public class AssignmentTwo {
	...
	public static void main(String[] args) {
		...
		final int AGV1_PROGRAM_SIZE_BYTES = START_AND_STOP_BYTECODES_SIZE + 6 + 2 * Double.BYTES + Long.BYTES
		...
		final int AGV2_PROGRAM_SIZE_BYTES = START_AND_STOP_BYTECODES_SIZE + 6 + 2 * Double.BYTES + Long.BYTES
				+ 2 * Float.BYTES + 2 * Integer.BYTES;
		...
		byte[] requestInfoProgramRawOutput = ((ByteArrayOutputStream) ip1.processResources(0, 0).getData())
				.toByteArray();
